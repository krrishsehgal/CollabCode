    ...
    <nav className="h-14 glass border-b border-glass-border flex items-center justify-between px-5 z-50">
      <div className="flex items-center gap-3">
        <motion.div
          ...
          className="w-8 h-8 rounded-lg bg-neon-purple flex items-center justify-center neon-glow-purple"
        >
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="w-8 h-8 rounded-full bg-neon-pink ring-2 ring-neon-purple/30" />
